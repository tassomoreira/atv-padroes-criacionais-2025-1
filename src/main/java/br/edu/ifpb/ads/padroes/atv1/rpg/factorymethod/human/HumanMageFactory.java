...
import br.edu.ifpb.ads.padroes.atv1.rpg.abstractfactory.human.HumanMageAbstractFactory;
...
public class HumanMageFactory implements CharacterFactory {

    public Character create(String name) {
        CharacterAbstractFactory factory = new HumanMageAbstractFactory();
