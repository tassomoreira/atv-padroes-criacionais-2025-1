...
import br.edu.ifpb.ads.padroes.atv1.rpg.abstractfactory.orc.OrcArcherAbstractFactory;
...
public class OrcArcherFactory implements CharacterFactory {

    public Character create(String name) {
        CharacterAbstractFactory factory = new OrcArcherAbstractFactory();
