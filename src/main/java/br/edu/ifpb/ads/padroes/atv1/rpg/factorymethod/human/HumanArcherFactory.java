...
import br.edu.ifpb.ads.padroes.atv1.rpg.abstractfactory.human.HumanArcherAbstractFactory;
...
public class HumanArcherFactory implements CharacterFactory {

    public Character create(String name) {
        CharacterAbstractFactory factory = new HumanArcherAbstractFactory();
