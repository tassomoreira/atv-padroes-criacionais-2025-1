...
import br.edu.ifpb.ads.padroes.atv1.rpg.abstractfactory.elf.ElfMageAbstractFactory;
...
public class ElfMageFactory implements CharacterFactory {

    public Character create(String name) {
        CharacterAbstractFactory factory = new ElfMageAbstractFactory();
